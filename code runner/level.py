...
class Level:
    ...
    def vertical_movement_collision(self):
        ...
        if player.on_ceilling and player.direction.x > 0 or player.direction.x < 1:
            player.on_ceilling = False #this basically stops the big headache that we had of the player jumping more than it should 
